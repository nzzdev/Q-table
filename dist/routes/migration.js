...
module.exports = {
    ...
    handler: function (request, h) { return __awaiter(_this, void 0, void 0, function () {
        var item, results, isChanged;
        return __generator(this, function (_a) {
            item = request.payload.item;
            results = migrationScripts.map(function (script) {
                var result = script.migrate(item);
                if (result.isChanged) {
                    item = result.item;
                }
                return result;
            });
            isChanged = results.findIndex(function (result) {
            ...
            return [2 /*return*/, h.response().code(304)];
        });
    }); }
};
